...
function sendHiMessage(recipientId) {
  ...
  var messageData = {
    ...
    message: {
      text: `Радий тебе бачити) Хочешь познайомлю тебе з тим що я вмію?`
    }
  }
    ...
    message: {
      attachment: {
        ...
        payload: {
          ...
          text: "Для взаємодії с системою виберіть дію",
          buttons:[{
            type: "postback",
            payload: "/пошук",
            title: "Пошук"
 ...
 /* var messageData = {
    ...
    message: {
      attachment: {
        ...
        payload: {
          template_type: "button",
          text: "Для взаємодії з користувачами",
          buttons:[{
            type: "postback",
            payload: "https://www.oculus.com/en-us/rift/",
            title: "бла бла бла"
          }, {
            type: "postback",
